...
- 🤖 **模型服务** — 供应商/模型配置、连通测试、默认角色（助手/翻译/视觉…），密钥 safeStorage 加密
- 🧾 **提示词库 + LLM 补全** — 本地模板 CRUD，按角色一键 `llm.complete`（OpenAI 兼容 / Anthropic / Ollama / Gemini）
- 🧠 **技能 / 工具箱 / 对话** — 技能包、网络搜索、文档抽取、向量嵌入、环境探测、薄版 Agent 对话

...
import logoVite from '@/shared/assets/logo-vite.svg'
import logoElectron from '@/shared/assets/logo-electron.svg'
import logoTailwind from '@/shared/assets/logo-tailwindcss.svg'

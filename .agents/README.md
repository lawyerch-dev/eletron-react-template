...
| Skill | 用途 |
|-------|------|
| [`template-architecture`](skills/template-architecture/SKILL.md) | 目录/依赖/IPC/capabilities/插件架构约定（改结构前必读） |
...
- 架构类问题先读 `template-architecture`，再读 `docs/guide/directory-structure.md`

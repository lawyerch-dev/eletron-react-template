...
For more information, please refer to [features/update/index.tsx](https://github.com/lawyerch-dev/electron-react-template/blob/main/src/features/update/index.tsx)

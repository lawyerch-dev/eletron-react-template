const zhCN = {
  ...
  // MCP
  'mcp.title': 'MCP',
  'mcp.nav.servers': '已安装 MCP',
  'mcp.nav.discover': '发现',
  'mcp.nav.builtin': '内置服务器',
  'mcp.nav.market': '市场',
  'mcp.nav.providers': '提供商',
  'mcp.nav.providers_hint': '第三方 MCP 提供商可在此扩展',
  'mcp.search_ph': '搜索服务器…',
  'mcp.menu.quick': '快速创建',
  'mcp.menu.import_json': '从 JSON 导入',
  'mcp.menu.import_dxt': '导入 DXT 包',
  'mcp.menu.coming_soon': '即将支持',
  'mcp.import_ph': '粘贴 mcpServers 配置 JSON…',
  'mcp.import_do': '导入',
  'mcp.import_ok': '已导入服务器配置',
  'mcp.install': '安装',
  'mcp.badge_builtin': '内置',
  'mcp.market_hint': '在线市场可对接插件市场能力，暂用内置预设',
  'mcp.subtitle': '管理已安装 MCP 服务器：内置预设 · JSON 导入 · 进程内/stdio',
  'mcp.config_hint':
    '配置：userData/mcp-servers.json。默认 seed 进程内 Memory/Fetch；stdio 走 npmmirror + 清华 PyPI。',
  'mcp.refresh': '刷新',
  'mcp.empty': '暂无已安装 MCP。可通过「添加 → 快速创建」或「内置服务器」安装。',
  'mcp.online': '已连接',
  'mcp.offline': '未连接',
  'mcp.connect': '连接',
  'mcp.disconnect': '断开',
